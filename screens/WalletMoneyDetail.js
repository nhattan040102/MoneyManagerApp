...
const WalletMoneyDetail = (props) => {
    ...
    return (<View>
        <View style={{ flexDirection: "column", padding: 10, marginBottom: 10, width: '100%' }}>
            ...
            <Text style={{ fontSize: FONTSIZE.header1 }}>  {formatMoney(money ? money.cash + money.debit_card : 0)} VND</Text>
        </View>
        ...
        <View style={{ flexDirection: "column", padding: 10, marginBottom: 10, width: '100%' }}>
            ...
            <Text style={{ fontSize: FONTSIZE.header1 }}>  {formatMoney(money ? money.cash : 0)} VND</Text>
        </View>
        ...
        <View style={{ flexDirection: "column", padding: 10, marginBottom: 10, width: '100%' }}>
            ...
            <Text style={{ fontSize: FONTSIZE.header1 }}>  {formatMoney(money ? money.debit_card : 0)} VND</Text>
        </View>
    </View>)
}
